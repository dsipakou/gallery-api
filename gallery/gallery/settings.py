...
DEFAULT_FILE_STORAGE = "images.utils.CustomS3Boto3Storage"
...
CELERY_BROKER_URL = f"redis://{REDIS_SERVER}:6379"
CELERY_RESULT_BACKEND = f"redis://{REDIS_SERVER}:6379"
...
CELERY_BEAT_SCHEDULE = {
    "proceed_images": {
        "task": "images.tasks.clear_latest_prop",
        "schedule": crontab(day_of_week="6", hour="11"),
    }
}
